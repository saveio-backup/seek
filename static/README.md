...
**<font size=4 color=#000>文件导入：</font>**登出后点击Import Account导入账户文件。文件导入可以分为Keystore File 导入和Pirvate Key导入，其中Keystore File 导入需要验证密码。而，Private Key导入不需要密码，而是需要导入后重新设定密码。

### 四，个人中心
<!-- **<font size=5 color=#000>新建通道:</font>**  
<br/> -->
...
### 五，钱包
<!-- **<font size=5 color=#000>划转资金:</font>**  
<br/> -->
...
点击Upload按钮，进行文件上传  
<!-- <br/>
**<font size=5 color=#000>高级模式的上传（Advance Upload）:</font>**  
<br/> -->

#### 高级模式的上传（Advance Upload）

高级上传不会占用购买的空间，及在不购买空间的情况下也能够进行文件上传，高级模式下，所有的参数都是可以修改并且自定义。具体参数如下：  
...
<!-- <br/>
<font size=5 color=#000>购买空间</font>  
<br/> -->
#### 购买空间
...
<!-- <br/>
<font size=5 color=#000>基础上传模式</font>  
<br/> -->
...
<!-- <br/>
<font size=5 color=#000>文件传输列表</font>  
<br/> -->
...
<!-- <br/>
<font size=5 color=#000>文件管理列表</font>  
<br/> -->
...
<!-- <br/>
<font size=5 color=#000>文件下载</font>  
<br/> -->
